...
PA_lm <- lm(pm25 ~ pm25_monitor + humidity, data = sensorMonitorData_1)
summary(PA_lm)
...
PA_lm <- lm(pm25 ~ pm25_monitor + humidity, data = sensorMonitorData_2)
summary(PA_lm)
...
PA_lm <- lm(pm25 ~ pm25_monitor + humidity, data = sensorMonitorData_3)
summary(PA_lm)
...
PA_lm <- lm(pm25 ~ pm25_monitor + humidity, data = sensorMonitorData_4)
summary(PA_lm)
