...
https://www.lrapa.org/294/What-is-LRAPA
...
For this study, we used the best performing sensor colocated with an FRM monitor (distance ~ 21 m). As you can see from the plots below, this PA sensor performed well throughout the entire 4 months period explored. 

```{r}
setArchiveBaseUrl("http://data.mazamascience.com/PurpleAir/v1")
getArchiveBaseUrl() # check the url is correctly set
setArchiveBaseDir(NULL)
Amazon_Park <- pas_load() %>%
  pas_filter(stringr::str_detect(label, "LRAPA-Amazon Park"))
Amazon_Park_ID <- pas_getDeviceDeploymentIDs(Amazon_Park)
